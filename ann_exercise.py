...
def main():
    ...
    operates_ann(ann, output_nodes, desired_target_test)

    plt.show()  # for show the plotted images


def operates_ann(ann: NeuralNetwork, output_nodes: int, desired_target_test: int):
    # START TRAINING
